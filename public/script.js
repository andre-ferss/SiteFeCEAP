...
function onOff2(){
    //Exibe ou esconde o modal
    document
        .querySelector("#delete")//acha o modal via DOM
        .classList.toggle("hide");//muda a class do modal
    ...
    //Habilitar scroll pro modal, caso "estoure" o tamanho da tela
    document
        .getElementById("delete")//1 - achar o modal via DOM
        .classList.toggle("addScroll");//2 - habilitar scroll no modal
...
function onOff3(){
    //Exibe ou esconde o modal
    document
        .querySelector("#update")//acha o modal via DOM
        .classList.toggle("hide");//muda a class do modal
    ...
    //Habilitar scroll pro modal, caso "estoure" o tamanho da tela
    document
        .getElementById("update")//1 - achar o modal via DOM
        .classList.toggle("addScroll");//2 - habilitar scroll no modal
